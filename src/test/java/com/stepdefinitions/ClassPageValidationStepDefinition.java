...
public class ClassPageValidationStepDefinition {
	...
	public void admin_should_land_on_the_manage_class_page(String string) {
		 System.out.println("I am inside class feature scenrio1 - then");
		 boolean result =cpv.validateNavBarClassNav(string);
