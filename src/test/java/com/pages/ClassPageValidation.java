...
public class ClassPageValidation {
	 ...
	 @CacheLookup
	 private WebElement CLASS_NV;
	 @FindBy(xpath="//div[text()=' Manage Class']")
	 @CacheLookup
	 private WebElement MANAGECLASSTEXT;

	 private String CLASS_URL="https://feb-ui-hackathon-bbfd38d67ea9.herokuapp.com/session";
	 ...
	 public boolean validateNavBarClassNav(String moduleName) {
		    if (moduleName != null && moduleName.equalsIgnoreCase("Manage Class")) {
	...
	//	 WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Class']")));
